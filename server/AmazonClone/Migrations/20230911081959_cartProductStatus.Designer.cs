...
namespace AmazonClone.Migrations
{
    ...
    [Migration("20230911081959_cartProductStatus")]
    partial class cartProductStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmazonClone.Domain.Entities.Address", b =>
                {
                    ...
                    b.Property<string>("addressComplete")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("addressComplete");
                    ...
                    b.ToTable("Address", "AmazonClone");
                });

            modelBuilder.Entity("AmazonClone.Domain.Entities.Bought", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Bougth", "AmazonClone");
                });

            modelBuilder.Entity("AmazonClone.Domain.Entities.BoughtProduct", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("BougthProduct", "AmazonClone");
                });
            ...
            modelBuilder.Entity("AmazonClone.Domain.Entities.Refund", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AmazonClone.Domain.Entities.BoughtProduct", b =>
                {
                    b.HasOne("AmazonClone.Domain.Entities.Bought", null)
                        .WithMany("products")
